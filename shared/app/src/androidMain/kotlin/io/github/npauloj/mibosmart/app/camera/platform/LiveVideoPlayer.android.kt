...
/**
 * The errors that mean "the stream dropped" rather than "this stream cannot be played". V-02
 * retries the first kind and offers the web player for the second (SPEC V4, V5).
 */
