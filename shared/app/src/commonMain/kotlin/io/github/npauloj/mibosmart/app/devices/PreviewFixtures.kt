...
internal object PreviewFixtures {
    ...
    val fullPage: List<DeviceRow> = buildList {
        add(device(1, "MFR 1001", "IOT-MFR1001-IB", isSubDevice = true, parent = HUB_ID))
        add(device(2, "MCA 1002", HUB_MODEL, id = HUB_ID))
        ...
        add(device(6, "MFR 2040", "IOT-MFR2040-IB", isSubDevice = true, parent = HUB_ID, isOnline = false))
