 ...
 * ADR-006). A token that has expired meanwhile comes back as a 401/403 on that request, and S-02b's
 * guard is what turns it into a trip back to the token screen (SPEC S6).
 */
