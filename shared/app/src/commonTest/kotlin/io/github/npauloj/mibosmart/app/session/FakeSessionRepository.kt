...
/**
 * A partner that answers whatever the test wants, and counts how often it was asked — the
 * account pays per request (ADR-006), so "how many calls" is part of the behaviour under test.
 */
