...
/**
 * The `Context` is read from the graph when the file is opened, not while the module is declared:
 * nothing should touch the disk because a binding exists (same rule as the vault, ADR-008).
 */
